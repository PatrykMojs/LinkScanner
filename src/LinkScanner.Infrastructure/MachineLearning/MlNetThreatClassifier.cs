...
public sealed class MlNetThreatClassifier : IThreatClassifier
{
        ...
        float probability)
    {
        ...
        {
            reasons.Add("The model has very high confidence that this URL is suspicious.");
        }
        else if (prediction.IsSuspicious && probability >= 0.70f)
        {
            reasons.Add("The model detected multiple suspicious URL patterns.");
        }
        else if (probability >= 0.40f)
        {
            reasons.Add("The model detected some potentially suspicious URL patterns, but confidence is moderate.");
        }
        else
        {
            reasons.Add("The model did not detect strong phishing-like patterns.");
        }

        reasons.Add($"Raw model score: {prediction.Score:0.0000}");
